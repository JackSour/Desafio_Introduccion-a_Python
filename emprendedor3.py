...
# Solicitar al usuario que ingrese las utilidades anteriores
utilidades_anteriores = float(input("Ingrese las utilidades anteriores: "))

# Formula calculo razon utilidades
